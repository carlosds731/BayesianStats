...
if __name__ == "__main__":
    data_monaco = [0, 0, 2, 2, 3, 0, 3, 4, 1, 3, 1, 0, 1, 1, 2, 3, 0, 5, 3, 1, 1, 1, 1, 2, 1, 1, 1, 1]
    with pm.Model() as model_prior_1:
        lmbda = pm.Gamma('lmbda', alpha=4.57, beta=1.43)
        # Likelihood
        y = pm.Poisson('y', mu=lmbda, observed=data_monaco)
    ...
    # Calculate the Bayes factors of model 2 against the other models
    print(likelihoods_under_model_2 / likelihoods_under_model_1)
    print(likelihoods_under_model_2 / likelihoods_under_model_3)
    print(likelihoods_under_model_2 / likelihoods_under_model_4)

    # The BF indicates that Model 2 works better, specially against model 3.
